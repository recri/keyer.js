...
** [ ] run keyer logic in the sample stream
...
** [ ] esc key not canceling output, button?
** [x] no selector for midi device
** [ ] no straight key choice for midi
** [ ] no envelope choice.
** [ ] keyboard output grab scrolls entire screen .
** [ ] ramp computation only used one envelope.   
** [x] must special case requestedSampleRate in start
** [x] use 1µs/div text labels for timestep and vertstep
** [ ] use < > step buttons for timestep and vertstep   
...
** [ ] saving to localStorage is wonky
